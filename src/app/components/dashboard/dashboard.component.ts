...
import { StatsService } from 'src/app/services/expense/stats/stats.service';
...
export class DashboardComponent {
  ...
  @ViewChild('incomeLineCharRef') private incomeLineCharRef:ElementRef;
  @ViewChild('expenseLineCharRef') private expenseLineCharRef:ElementRef;
  ...
  createLineChart(){
    const incomeCtx=this.incomeLineCharRef.nativeElement.getContext('2d');
    new Chart(incomeCtx, {
      type: 'line',
      data: {
    ...
    const expenseCtx=this.expenseLineCharRef.nativeElement.getContext('2d');
